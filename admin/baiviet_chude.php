...
if ($total_records == 0) {
    ...
    // BƯỚC 5: TRUY VẤN DANH SÁCH BÀI VIẾT ĐÃ DUYỆT
    ...
    while ($row = $danhsach->fetch_array(MYSQLI_ASSOC)) {
        ...
        echo '  <img class="baiviet-hinh" src="' . htmlspecialchars($image_path) . '" alt="Hình bài viết">';
